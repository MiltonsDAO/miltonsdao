  ...
  function circulatingSupply() public view returns (uint256) {
    string memory message = string(
      abi.encodePacked(
        ...
        Strings.toString(balanceOf(stakingContract))
      )
    );
    // require(_totalSupply >= balanceOf(stakingContract), message);
    return _totalSupply.sub(balanceOf(stakingContract), message);
  }
